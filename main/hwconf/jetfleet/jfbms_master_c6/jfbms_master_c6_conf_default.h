// JFBMS Master C6 config defaults
// Based on VBMS32 defaults + master-specific parameters

#ifndef JFBMS_MASTER_C6_CONF_DEFAULT_H_
#define JFBMS_MASTER_C6_CONF_DEFAULT_H_
